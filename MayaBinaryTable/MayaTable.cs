...
namespace MayaBinaryTable
{
	public static class MayaTable
	{
		...
		private const string RESOURCE_NAME = "MayaBinaryTable.table.csv";
		...
		public static bool HasMatchesWithFilter(string str, IEnumerable<string> filter) => MayaRawTable.Any(elem => elem.Item2.StartsWith(str) && filter.All(s => s != elem.Item2));
